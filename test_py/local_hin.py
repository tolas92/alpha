...
model_local = ChatOllama(model="navarna:latest")
embed=HuggingFaceEmbeddings(model_name="/home/tolasing/Downloads/hindi_sentence")

loader = PyPDFLoader("/home/tolasing/Downloads/ginger.pdf",extract_images=True)
...
query = "show all hindi words in document"
